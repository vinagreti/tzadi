...
$.each(foundProducts, function(key, value){
    ...
    this.getFormData = function( id ){
      ...
      if(line.find(".courseDurationValue") && objProduct.courseDurationValue != line.find(".courseDurationValue").val()) formData.courseDurationValue = line.find(".courseDurationValue").val();
      ...
      if(line.find(".courseRequirements") && objProduct.courseRequirements != line.find(".courseRequirements").val()) formData.courseRequirements = line.find(".courseRequirements").val();
      if(line.find(".ensuranceDurationValue") && objProduct.ensuranceDurationValue != line.find(".ensuranceDurationValue").val()) formData.ensuranceDurationValue = line.find(".ensuranceDurationValue").val();
      ...
      if(line.find(".accommodationPeopleNumber") && objProduct.accommodationPeopleNumber != line.find(".accommodationPeopleNumber").val()) formData.accommodationPeopleNumber = line.find(".accommodationPeopleNumber").val();
      if(line.find(".accommodationDurationValue") && objProduct.accommodationDurationValue != line.find(".accommodationDurationValue").val()) formData.accommodationDurationValue = line.find(".accommodationDurationValue").val();
      ...
      if(line.find(".passFrom") && objProduct.passFrom != line.find(".passFrom").val()) formData.passFrom = line.find(".passFrom").val();
      if(line.find(".passTo") && objProduct.passTo != line.find(".passTo").val()) formData.passTo = line.find(".passTo").val();
