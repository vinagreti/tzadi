 ...
 <br>
      ...
      <div class="row-fluid pricing-table pricing-three-column">
        ...
        <div class="span6 plan">
          ...
          <ul>
            <li class="plan-feature">2 Usuários</li>
        ...
        <div class="span6 plan">
          <div class="plan-name-silver">
            ...
            <span><strike>$16.99</strike>   <font color="red">$14.99 - <span class="label label-warning">Sale</span></font></span>
          </div>
          <ul>
            <li class="plan-feature">5 Usuários</li>
            <li class="plan-feature"><a href="#" class="btn btn-primary btn-plan-select"><i class="icon-white icon-ok"></i> Select</a></li>
          </ul>
        </div>
        ...
        <div class="span6 plan">
          ...
          <ul>
            <li class="plan-feature">Sem limite de usuários</li>
            <li class="plan-feature"><a href="#" class="btn btn-primary btn-plan-select"><i class="icon-white icon-ok"></i> Select</a></li>
          </ul>
        </div>
