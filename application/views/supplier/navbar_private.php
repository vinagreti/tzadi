<div class="container-fluid">
  ...
  <a class="orgImg brand" href="<?=myOrg_url()?>" style="background: url(<?=$this->session->userdata("orgImg")?>) no-repeat left center; background-size: 100%; height:20px; width: 20px; margin:0px 5px;"></a>
  <span class="brand">
    <a class="profileName" href="<?=myOrg_url()?>"><?= $this->session->userdata("orgName")?></a>
  </span>
